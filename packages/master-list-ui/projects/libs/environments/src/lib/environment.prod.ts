...
export const environment = {
    ...
    baseUrl: 'https://criticalpass2.azurewebsites.net',
    ...
    redirectUri: 'https://criticalpass2.azurewebsites.net/login-redirect', //'https://criticalpass2.azurewebsites.net/welcome',
    cacheLocation: 'sessionStorage',
    loginScopes: ['openid', 'offline_access'],
    exposedApiScope: 'https://criticalplayground.onmicrosoft.com/api/read',
    postLogoutUrl: 'https://criticalpass.io', //'https://criticalpass2.azurewebsites.net/home/',
